...
public class CustomArrayFactoryImpl implements CustomArrayFactory {
    ...
    @Override
    public CustomArray createEmptyCustomArray() throws CustomArrayException {
    ...
    @Override
    public CustomArray createWithSizeCustomArray(int size) throws CustomArrayException{
    ...
    @Override
    public CustomArray createFilledWithValueCustomArray(int size, int value) throws CustomArrayException{
        ...
        CustomArray result = new CustomArray(size, value);
        logger.info("CustomArray created successfully with size: {}, filled with value: {}", size, value);
        return result;
    }

    @Override
    public CustomArray createFromArrayCustomArray(double[] array) throws CustomArrayException {
